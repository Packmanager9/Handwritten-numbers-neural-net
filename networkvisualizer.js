...
window.addEventListener('DOMContentLoaded', (event) => {
    window.setTimeout(function () {
            ...
            constructor(inputs, layercount, layersetupArray, outputs = 2, override = 0) {
                if (override == 0) {
                    ...
                    if (this.outputcheck == 0) {
                        this.outputMagnitudes[this.outputMagnitudesClone.indexOf(Math.max(...this.outputMagnitudesClone))] = 1
                    }
        ...
        //     // let SandMesh = new GenNN([...inputArray], 3, [Math.floor(Math.random()*32)+10, Math.floor(Math.random()*32)+10, 10], 4)
        //     let SandMesh = new GenNN([...inputArray], 5, [10,10,10,10, 10], 4)
        ...
        let mutationratebig = .00019
        let mutationrate = .00009
        let mutationratesmall = .000009
        let mutationratemicro = .0000019
        let difficulty = .5
        let numcounter = 0
        ...
        //     // for(let k = 0;k<(120-meshes.length);k++){
        //     //     // if(Math.random()<.1){
        ...
        //     if (meshes.length < 50) {
        //         SandMesh.bigmutate()
        //     } else if (meshes.length < 160) {
        //         SandMesh.mutate()
        //     } else if (meshes.length < 220) {
        //         SandMesh.smallmutate()
        //     } else if (meshes.length < 400) {
        //         SandMesh.micromutate()
        //     }
        //     meshes.push(SandMesh)
        // }
        ...
        function main() {
            ...
            // } else if (counter % counterstop == 0 && counter > 0) {
            ...
            //         console.log("dropped", (20 - meshes.length), "difficulty", difficulty, "best", meshes[0], "number", variablenumber, "output", meshes[0].outputMagnitudes, "rate", 100 * (meshes[0].wrong / (meshes[0].correct + meshes[0].wrong)), `${meshes[0].wrong}/${meshes[0].correct + meshes[0].wrong}`)
            ...
            //         // }
            //     } else {
            //         console.log("dropped", (400 - meshes.length), "difficulty", difficulty, "best", meshes[0], "number", variablenumber, "output", meshes[0].outputMagnitudes, "rate", 100 * (meshes[0].wrong / (meshes[0].correct + meshes[0].wrong)), `${meshes[0].wrong}/${meshes[0].correct + meshes[0].wrong}`, imgindex)
            ...
            //     for (let t = 0; meshes.length < 20; t++) {
            //         let SandMesh = meshes[0].clone()
            //         // for(let k = 0;k<(120-meshes.length);k++){
            //         //     // if(Math.random()<.1){
            //         //         SandMesh.smallmutate()
            ...
            //         meshes[t].marked = 1
            //     }
            //     if (Number.isNaN(meshes[t].fitness)) {
            //         meshes[t].marked = 1
            //     }
            // }
            ...
            //     for(let g = 0;g<meshes[0].structure[0].length;g++){
            //         for (let k = 0; k < meshes[0].structure[0][g].weights.length; k++) {
            //             if(meshes[0].structure[0][g].weights[k] < 0){
            //                 canvas_context.fillStyle = `rgba(255,0,0,${Math.abs(meshes[0].structure[0][g].weights[k])/10})`
            //             }else{
            //                 canvas_context.fillStyle = `rgba(0,255,255,${meshes[0].structure[0][g].weights[k]})`
            //             }
            //             canvas_context.fillRect((Math.floor(k/28))*28, (k%28)*28, 28, 28)
            //         //     x += 35
            //         //     if (x == 700) {
            //         //         x = 0
            //         //         y += 35
            ...
            for (let t = 0; t < meshes[0].structure.length; t++) {
                for (let k = 0; k < meshes[0].structure[0][boing].weights.length; k++) {
                    if(meshes[0].structure[0][boing].weights[k] < 0){
                        canvas_context.fillStyle = `rgba(255,0,0,${Math.abs(meshes[0].structure[0][boing].weights[k])})`
                    }else{
                        canvas_context.fillStyle = `rgba(0,255,255,${meshes[0].structure[0][boing].weights[k]})`
                    }
                    canvas_context.fillRect((Math.floor(k/28))*28, (k%28)*28, 28, 28)
                //     x += 35
                //     if (x == 700) {
            ...
            //     if (meshes.length > 10) {
            //         meshes.splice(meshes.length - 2, 2)
            //     }
            // }
            // if (keysPressed['h']) {
            //     if (meshes.length > 10) {
            //         meshes.splice(meshes.length - 10, 10)
            //     }
            // }
        }
